...
namespace Automat.Application.Handlers.Payment.PaymentTypeOption.Commands
{
    ...
    public class AddPaymentTypeOptionCommandHandler : IRequestHandler<AddPaymentTypeOptionCommand, GenericResponse<PaymentTypeOptionDto>>
    {
        ...
        public async Task<GenericResponse<PaymentTypeOptionDto>> Handle(AddPaymentTypeOptionCommand request, CancellationToken cancellationToken)
        {
            try
            {
                #region Validation
                ...
                var result = new PaymentTypeOptionDto(paymentType.Id, paymentType.Id, paymentType.Name, paymentTypeOption.Name, paymentTypeOption.RefundPaymentStatus);
